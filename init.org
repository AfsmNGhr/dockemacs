...
[[https://hub.docker.com/r/afsmnghr/dockemacs/][https://img.shields.io/docker/v/afsmnghr/dockemacs?style=flat]]
[[https://hub.docker.com/r/afsmnghr/dockemacs/][https://img.shields.io/docker/image-size/afsmnghr/dockemacs]]
...
alias dockemacs='
  docker run -it --rm --net=host \
       ...
       afsmnghr/dockemacs:1.12.1 startup
'
#+end_src
...
Disable check signature for Travis.
