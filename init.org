...
** The minimal emacs noX ([[https://github.com/AfsmNGhr/dockemacs/tree/dockemacs][Dockerized version]])
...
[[https://travis-ci.com/AfsmNGhr/dockemacs][https://travis-ci.com/AfsmNGhr/dockemacs.svg?branch=master]]
...
Download and run literate emacs configuration.

#+begin_src shell :tangle no
git clone https://github.com/AfsmNGhr/dockemacs.git ~/.emacs.d
~/.emacs.d/sbin/tangle
emacs
#+end_src
...
#+begin_src elisp
(use-package cus-edit :defer t :ensure f
...
#+begin_src elisp
(use-package reverse-im :defer 1
...
(use-package keyword-search :defer t
  ...
  :custom ((afsmnghr/search-alist
            '((t/ya-en-ru . "https://translate.yandex.ru/?text=%s&lang=en-ru")
             ...
             (alpine/pkgs . "https://pkgs.alpinelinux.org/packages?name=%s")
...
(use-package org :defer 5 :ensure f
  ...
  (custom-set-variables
   '(org-babel-load-languages
     (quote ((emacs-lisp . t) (python . t) (shell . t) (ruby . t) (js . t) (sql . t))))
