...
╼►[benchmark-init/root nil 1739ms]
  ...
  ├─[~/.emacs.d/conf.d/ruby load 1274ms]
  ├─[~/.emacs.d/conf.d/remote load 4ms]
  │ ╰─[tramp require 12ms]
  ...
  ├─[~/.emacs.d/conf.d/interface load 16ms]
  │ ╰─[filenotify require 2ms]
  ├─[~/.emacs.d/conf.d/hooks load 0ms]
  ├─[~/.emacs.d/conf.d/features load 69ms]
  │ ├─[compile require 6ms]
  │ │ ╰─[comint require 6ms]
