...
╼►[benchmark-init/root nil 5608ms]
  ...
  ├─[~/.emacs.d/el-get/yasnippet/snippets/prog-mode/.yas-compiled-snippets load 0ms]
  ├─[~/.emacs.d/el-get/yasnippet/snippets/emacs-lisp-mode/.yas-setup load 0ms]
  ├─[~/.emacs.d/el-get/yasnippet/snippets/emacs-lisp-mode/.yas-compiled-snippets load 0ms]
  ├─[~/.emacs.d/el-get/yasnippet/snippets/lisp-interaction-mode/.yas-setup load 0ms]
  ├─[~/.emacs.d/el-get/yasnippet/snippets/lisp-interaction-mode/.yas-compiled-snippets load 0ms]
  ├─[default load 2ms]
  ...
  │ ├─[~/.emacs.d/el-get/yasnippet/snippets/fundamental-mode/.yas-setup load 0ms]
  │ ├─[~/.emacs.d/el-get/yasnippet/snippets/fundamental-mode/.yas-compiled-snippets load 0ms]
